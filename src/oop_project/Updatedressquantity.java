...
public class Updatedressquantity extends JFrame {
    JButton b1, b2;
     JLabel l1,l2;
     JTextField t1,t2;
    Updatedressquantity()
    {
        ...
        l2=new JLabel("Enter the updated quantity");
      ...
      public void actionPerformed(ActionEvent ae)
      {
         if("Submit".equals(ae.getActionCommand()))
         {
             ...
             else
             {
                 ...
                 {
                   if(Dresses.checkQuantity(t2.getText())==true)
                   {
                    Dresses.UpdateQuantity(t1.getText(), t2.getText());
