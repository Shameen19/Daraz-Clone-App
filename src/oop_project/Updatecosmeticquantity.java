...
public class Updatecosmeticquantity extends JFrame {
    JButton b1, b2;
     JLabel l1,l2;
     JTextField t1,t2;
    Updatecosmeticquantity()
      ...
      public void actionPerformed(ActionEvent ae)
      {
         if("Submit".equals(ae.getActionCommand()))
         {
             ...
             else
             {
                 ...
                 {
                   if(Cosmetics.checkQuantity(t2.getText())==true)
                   {
                      Cosmetics.UpdateQuantity(t1.getText(), t2.getText());
