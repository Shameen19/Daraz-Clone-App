...
public class Updateappliancesprice extends JFrame 
{
     JButton b1, b2;
     JLabel l1,l2;
     JTextField t1,t2;
      ...
      public void actionPerformed(ActionEvent ae)
      {
         if("Submit".equals(ae.getActionCommand()))
         {
             ...
             else
             {
                 ...
                 {
                   if(HomeAppliances.checkPrice(t2.getText())==true)
                   {
                     HomeAppliances.UpdatePrice(t1.getText(), t2.getText());
