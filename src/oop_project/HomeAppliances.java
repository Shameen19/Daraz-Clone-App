...
public class HomeAppliances implements Serializable 
{
    ...
    public HomeAppliances(String code,String brand, String quantity, String name,String price)
    {
        this.code=code;
        this.brand=brand;
    ...
    public  static void writeProduct(HomeAppliances homeappliances)
    {
        ArrayList<HomeAppliances> list = readAllDataFromFile();
        list.add(homeappliances);
        try
        {
            ObjectOutputStream output = new ObjectOutputStream( new FileOutputStream("HOME APPLIANCES Record"));
    ...
    public  static  ArrayList<HomeAppliances> readAllDataFromFile(   )
    {
        ArrayList <HomeAppliances> list = new ArrayList<HomeAppliances>();
        
        try
        {
            ObjectInputStream input = new ObjectInputStream (new FileInputStream("HOME APPLIANCES Record"));
            list = (ArrayList<HomeAppliances>) input.readObject();
        }
    ...
    {
        ArrayList <HomeAppliances> list = readAllDataFromFile();
        System.out.println("HOME APPLIANCES CODE\t\tHOME APPLIANCES BRAND\t\tHOME APPLIANCES NAME\t\tHOME APPLIANCES QUZNTITY\t\tHOME APPLIANCES PRICE");
        for(int i=0;i<list.size();i++)
        {
          System.out.println(list.get(i).getCode()+"\t\t\t"+list.get(i).getBrand()+"\t\t\t"+list.get(i).getName()+"\t\t\t"+list.get(i).getQuantity()+"\t\t\t"+list.get(i).getPrice());  
        }
